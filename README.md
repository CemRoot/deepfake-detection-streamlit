...
## 📄 Published Research — Springer CCIS 2950

[![DOI](https://img.shields.io/badge/DOI-10.1007%2F978--3--032--25809--0__32-blue?style=for-the-badge)](https://doi.org/10.1007/978-3-032-25809-0_32)
[![Springer](https://img.shields.io/badge/Springer-CCIS%20vol.%202950-white?style=for-the-badge&logo=springer&logoColor=black)](https://link.springer.com/chapter/10.1007/978-3-032-25809-0_32)

This work has been formally published as a peer-reviewed conference paper in **Springer Nature's Communications in Computer and Information Science (CCIS), volume 2950**, as part of the proceedings of **AICS 2025** (33rd Irish Conference on Artificial Intelligence and Cognitive Science).

> Koyluoglu, E.C., Staikopoulos, A., Raj, K. (2026). *A Novel Deep Learning Framework for DeepFake Detection Using Attention-Enhanced EfficientNet-B7*. In: Mai, T.T., et al. Artificial Intelligence and Cognitive Science. AICS 2025. Communications in Computer and Information Science, vol 2950. Springer, Cham, pp. 401–413. https://doi.org/10.1007/978-3-032-25809-0_32

**📄 Paper:** [Springer Nature Link](https://link.springer.com/chapter/10.1007/978-3-032-25809-0_32) &nbsp;·&nbsp; **🔗 DOI:** [10.1007/978-3-032-25809-0_32](https://doi.org/10.1007/978-3-032-25809-0_32) &nbsp;·&nbsp; **🎓 ORCID:** [0009-0002-1117-0876](https://orcid.org/0009-0002-1117-0876)
...
**Published in Springer Nature CCIS, vol. 2950 — Presented at the 33rd Irish Conference on Artificial Intelligence and Cognitive Science (AICS 2025)**

Developed by **Emin Cem Koyluoglu**, with **Athanasios Staikopoulos** and **Kislay Raj**
...
- **Size:** 20,000 images, class-balanced (10,000 real / 10,000 fake)
- **Composition:** Authentic photographs paired with synthetic images spanning GAN-based and diffusion-based generators (see [Detection Capabilities](#detection-capabilities) below for the full list of generator families covered)
- **Split:** Held-out test split used for final evaluation, with augmentation applied during training (see Training below)

*Full dataset sourcing, licensing, and preprocessing details are documented in the published paper.*

## 🏋️ Training

- **Optimizers compared:** Adam and SGD
- **Augmentation:** Evaluated both with and without data augmentation
- **Regularization:** Early stopping, learning rate scheduling, dropout (0.5 / 0.25), L2 weight decay (λ = 0.00001)
- **Explainability:** LIME-based explainability used to interpret model predictions during evaluation

## 📈 Results

| Model | Accuracy |
|---|---|
| **EfficientNet-B7 + Custom Soft Spatial Attention (this work)** | **97%** |
| Standard EfficientNet-B7 | 96% |
| MobileNetV2 | 96% |
| VGG16 | 78% |
| Xception | 65% |
| Baseline CNN | 50% |

The proposed attention-enhanced EfficientNet-B7 outperformed every baseline architecture evaluated on the held-out test split. Full precision/recall/F1 breakdowns are reported in the published paper.

## 🔁 Reproducibility

This repository is designed to reproduce the detection framework described in the paper. Quick links:

- [Local Installation](#local-installation) — run the app on your own machine
- [Model Repository](#model-repository) — download the exact trained weights used in the paper
- [Project Structure](#project-structure) — source layout for the architecture, preprocessing, and training code
- [Model Architecture](#model-architecture) — full network diagram and specifications below
...
See the [Results](#-results) section above for the full accuracy comparison table. Detailed precision, recall, F1-scores, and ROC curves are available in the published paper.
...
This system was presented as a live demonstration at:

**33rd Irish Conference on Artificial Intelligence and Cognitive Science (AICS 2025)**

The accompanying research paper is formally published in Springer Nature CCIS, vol. 2950 — see [Published Research](#-published-research--springer-ccis-2950) at the top of this README.
...
If you use this system in your research, academic work, or build upon this implementation, please cite the published paper:
...
@inproceedings{koyluoglu2026deepfake,
  ...
  author    = {Koyluoglu, Emin Cem and Staikopoulos, Athanasios and Raj, Kislay},
...
```
Koyluoglu, E. C., Staikopoulos, A., & Raj, K. (2026). A novel deep learning
framework for DeepFake detection using attention-enhanced EfficientNet-B7.
In Artificial Intelligence and Cognitive Science. AICS 2025 (Communications
in Computer and Information Science, Vol. 2950, pp. 401–413). Springer,
Cham. https://doi.org/10.1007/978-3-032-25809-0_32
```
...
- **LinkedIn**: [in/cem-koyluoglu](https://www.linkedin.com/in/cem-koyluoglu/)
- **ORCID**: [0009-0002-1117-0876](https://orcid.org/0009-0002-1117-0876)
...
**Co-authors**: Athanasios Staikopoulos, Kislay Raj — School of Computing, National College of Ireland (Kislay Raj also affiliated with Dublin City University)
...
**Published in Springer Nature CCIS, vol. 2950 — AICS 2025**
33rd Irish Conference on Artificial Intelligence and Cognitive Science

**Developed by Emin Cem Koyluoglu, Athanasios Staikopoulos & Kislay Raj**
...
[GitHub Repository](https://github.com/CemRoot/deepfake-detection-streamlit) | [Live Demo](https://your-app-url.streamlit.app) | [Author Website](https://cemkoyluoglu.codes/) | [Published Paper (DOI)](https://doi.org/10.1007/978-3-032-25809-0_32)
